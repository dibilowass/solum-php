...
<div class="banner-layout">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
       <img src="assets\banners\banner-solum.png" class="banner-imagem-principal" alt="Banner principal1"> 
    </div>
    <div class="carousel-item">
       <img src="assets\banners\banner-solum2.png" class="banner-imagem-principal" alt="Banner principal2"> 
    </div>
    <div class="carousel-item">
       <img src="assets\banners\banner-solum3.png" class="banner-imagem-principal " alt="Banner principal3"> 
    </div>
  </div>
    ...
    <span class="visually-hidden">Próximo</span>
        ...
        <div class="banners-menores">
            <div class="banner-superior">
                <img src="sua-imagem-aqui.jpg" alt="Banner Superior" class="banner-imagem-menor">
            </div>
            <div class="banner-inferior">
                <img src="sua-imagem-aqui.jpg" alt="Banner Inferior" class="banner-imagem-menor">
            </div>
        </div>
    </div>
