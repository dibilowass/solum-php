...
<div id="carouselExample" class="carousel slide">
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExample" data-bs-slide="next">
    ...
    <div class="cards-container">
        <div class="card"><h1>Sobre a Naturalle</h1> <br>
        <img src="assets\icones\icone-info.png"><br>
       
         </div>
         <div class="card"><h1>Crie uma conta</h1> <br>
        <img src="assets\icones\icone-formulario.png">
         </div>
         <div class="card"><h1>Lojas Parceiras</h1> <br>
...
<strong> meio ambiente</strong><br> a prosperar. </spam>
<br>
